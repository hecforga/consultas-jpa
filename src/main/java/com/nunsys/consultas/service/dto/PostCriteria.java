...
/**
 * Criteria class for the {@link com.nunsys.consultas.domain.Post} entity. This class is used
 * in {@link com.nunsys.consultas.web.rest.PostResource} to receive all the possible filtering options from
...
public class PostCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, content, commentsId);
    }
